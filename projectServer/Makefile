...
SERVER_SOURCES=server.cpp tcpserver.cpp ccsocket.cpp Media.cpp Film.cpp Group.cpp MediaManager.cpp
CLISERV_SOURCES=client.cpp server.cpp tcpserver.cpp ccsocket.cpp 
#
